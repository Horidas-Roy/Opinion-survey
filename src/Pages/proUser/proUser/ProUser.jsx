    ...
    return (
        <div className="h-[100vh] flex justify-center">
            ...
            <div className="text-success text-center mb-10 text-2xl font-semibold">
                {
                  isProUser && <p>You already paid.And You already a Pro User.<Link to='/'><button className="btn bg-gradient-to-r from-[#e31048] to-[#ff5100] text-white font-bold text-xl py-2 px-4">Back Home</button></Link></p>
                }
             </div>
